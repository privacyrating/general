...
\begin{frame}{Projektmanagment}

    \begin{itemize}
        \item Aufteilung der Arbeit
         \begin{itemize}
...
\end{itemize}
\begin{itemize}
        \item Kommunikation und Dokumentation
         \begin{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
\begin{itemize}
        \item Vergleich urpsrung Anforderung mit Ergebnis
         \begin{itemize}
              \item tetststts
              \item testtt
              \item testtt
        ...
        \end{itemize}
    \end{itemize}
\begin{frame}{GWerdegang der App}

    \begin{columns}[t]
        \column{.5\textwidth}
        \centering
        \includegraphics[width=0.8\textwidth]{img/1.jpg}{Entwurf}\\
        \includegraphics[width=0.8\textwidth]{img/2.jpg}{Grundgerüst}
        \column{.5\textwidth}
        \centering
        \includegraphics[width=0.8\textwidth]{img/3.jpg}{Vorabversion}\\
        \includegraphics[width=0.8\textwidth]{img/4.jpg}{Finale Version}
    \end{columns}
