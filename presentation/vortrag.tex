...
\begin{frame}{Gute Parameter finden}
    ...
    \(\Rightarrow\) 42 Cluster\\
    \(\Rightarrow\) Mehr als 50\% Rauschen\\
    \(\Rightarrow\) 1 Cluster viel zu groß
...
\begin{frame}{Kombination mit anderen Algorithmen}
    ...
    \begin{itemize}
        \item K-Means
            \begin{itemize}
                \item Anzahl Cluster aus DBSCAN \(\rightarrow\) mäßiger Erfolg
                \item Anzahl GP Kategorien \(\rightarrow\) mäßiger Erfolg
            \end{itemize}
        \item Classifier
            \begin{itemize}
                \item DecisionTree \(\rightarrow\) mieserabler Erfolg
                \item BernoulliNB \(\rightarrow\) mieserabler Erfolg
                \item MLP \(\rightarrow\) mieserabler Erfolg
                \item AdaBoost \(\rightarrow\) mieserabler Erfolg
                \item KNeighbors  \(\rightarrow\) akzeptabler Erfolg
            \end{itemize}
    \end{itemize}

    \(\Rightarrow\) Kein Verlust mehr durch Rauschen\\
    \(\Rightarrow\) Zu großer Cluster wurde noch größer\\
    \(\Rightarrow\) Beinhaltet mehr als 50\% apps
...
\begin{frame}{Hierarchical DBSCAN}
    ...
    \(\Rightarrow\) Sprengt den Arbeitsspeicher.
    \begin{quote}
    ...
    \(\Rightarrow\) Clusterqualität wurde schlechter, kein guter Erfolg
