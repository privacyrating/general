...
/*
 * Removes evil parts from string
 */
function secure($str) {
    $str = trim($str);
...
/*
 * Checks if the given value exists and if it is an array
 * if not creates an empty array
 * else runs secure at each value inside array
 */
...
/*
 * Returns value from post request by given name
 */
...
/*
 *  Returns array from post request by given name
 */
...
/*
 * Processing post request formula from client
 */
...
/*
 * Get information for given app from database
 */
 ...
 *
 * $app_id_fit :: string
 *      App id from app that this app should match
 *
 * $match :: boolean
 *      App matches first app or not
 */
...
/*
 * Returns random app from given cluster
 */
...
/*
 * Returns three apps from same cluster for an app
 * and three apps from random clusters
 */
